// src/lib.rs
/*
 * Core library for PianoWorkshop
 */
...
#[derive(Debug)]
pub struct PianoWorkshopProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PianoWorkshopProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PianoWorkshop processing");
    
    let mut processor = PianoWorkshopProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PianoWorkshopProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PianoWorkshopProcessor::new(false);
